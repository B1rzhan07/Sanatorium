...
function LoggedInMenu({ handleLogout }: LoggedinMenuProps) {
  return (
    <>
      <DropdownMenuItem className="font-semibold">Messages</DropdownMenuItem>
      <DropdownMenuItem className="font-semibold">Trips</DropdownMenuItem>
      <DropdownMenuItem className="font-semibold">Wishlist</DropdownMenuItem>
      <DropdownMenuSeparator />
